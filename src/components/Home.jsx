  ...
  return (
    ...
    <div name='home' className='w-full h-screen bg-gradient-to-r from-[#020024]  to-[#00d4ff]'>
        ...
        <div className='max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full'>
            ...
            <h2 className='text-3xl sm:text-6xl font-bold text-[#e2e9fb] py-2'>I'm a front-end developer.</h2>
            <p className='text-[#bec2cd] py-1 max-w-[700px]'>I also have experience in full-stack 
                web applications.
            </p>
            <div>
